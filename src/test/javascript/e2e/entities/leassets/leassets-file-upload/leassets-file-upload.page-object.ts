...
export class LeassetsFileUploadComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('gha-leassets-file-upload div table .btn-danger'));
  title = element.all(by.css('gha-leassets-file-upload div h2#page-heading span')).first();
...
export class LeassetsFileUploadUpdatePage {
  pageTitle = element(by.id('gha-leassets-file-upload-heading'));
  ...
  leassetsFileTypeIdInput = element(by.id('field_leassetsFileTypeId'));
  ...
  async setLeassetsFileTypeIdInput(leassetsFileTypeId: string): Promise<void> {
    await this.leassetsFileTypeIdInput.sendKeys(leassetsFileTypeId);
  }

  async getLeassetsFileTypeIdInput(): Promise<string> {
    return await this.leassetsFileTypeIdInput.getAttribute('value');
  }
...
export class LeassetsFileUploadDeleteDialog {
  private dialogTitle = element(by.id('gha-delete-leassetsFileUpload-heading'));
  private confirmButton = element(by.id('gha-confirm-delete-leassetsFileUpload'));
